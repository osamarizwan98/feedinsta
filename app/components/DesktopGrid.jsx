...
function DesktopGrid({ preview, feedData, mediaData }) {
          ...
          <>
            {previewData.feedType === "grid" ? (
              <div className="gridtemplate"
                style={{
                  display: "grid",
                  gridTemplateColumns: `repeat(${previewData?.postColumns}, minmax(0, 1fr))`,
                  gap: previewData?.spacing,
                }}
              >
                {limitImages.map((item, index) => (
                  <Box as="div" key={index}>
                    <div className="preview_post_grid_item">
                    {item.media_type === "VIDEO" ? (
                      <video
                        ...
                        className="preview_post_grid_video"
                      />
                    ) : (
                      <img
                        src={item.media_url}
                    ...
                    <div className="instagram_logo">
                      <img
                        src="https://cdn.shopify.com/s/files/1/0646/8019/8301/files/bg_top_icon_fbf0e26a-8b3b-4675-8489-9a28fb89b687.svg?v=1710759935"
                        alt="Instagram Logo"
                      />
                    </div>
                    </div>
              ...
              <Swiper
                ...
                slidesPerView={previewData?.postColumns}
                navigation
                className="mySwiper"
                style={{ width: "100%" }}
              >
